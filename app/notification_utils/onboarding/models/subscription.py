...
from .device import AppInstance
...
class AppDeviceSubscriptions(models.Model):
    ...
    device = models.ForeignKey(
        AppInstance, on_delete=models.CASCADE, related_name='app_subscriptions')
    ...
    def __str__(self):
        return f"{self.device} | {self.payload} [{'Subscribed' if self.is_subscribed else 'Unsubscribed'}]"
